        ...
        <div className="flex justify-between items-end mt-14">
          <div>
            ...
            <div className="flex gap-3 items-center">
              <img
                className="h-4"
                src="https://www.pngkey.com/png/full/931-9311379_email-icons-white-color-white-email-icon-png.png"
                alt=""
              />
              <img
                className="h-5"
          ...
          <div className="flex items-center gap-4">
            <img className="h-6" src="https://iconape.com/wp-content/png_logo_vector/tailwind-css-logo.png" alt="" />
            <img className="h-6" src="https://cdn4.iconfinder.com/data/icons/logos-3/600/React.js_logo-512.png" alt="" />
          </div>
        </div>
      </div>
    </div>
